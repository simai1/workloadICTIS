...
function App() {
  ...
  const metodRole = {
    METHODIST: [
      ...
      16, 40, 47, 48, 50, 54, 54.1,
    ],
    LECTURER: [
      1.1, 8, 15, 17, 17.1, 38.2, 18, 20, 22, 24, 33.2, 34, 37, 41, 53, 51, 50,
      54,
    ],
    DEPARTMENT_HEAD: [
      2, 3, 4, 8, 9, 10, 11, 12, 13, 15, 17, 18, 20, 22, 23, 25, 26, 27, 30, 31,
      32, 33, 33.1, 34, 36, 16, 38, 39, 40, 49, 50, 51, 52, 54, 54.1, 56,
    ],
    DIRECTORATE: [
      1, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 54, 54.1, 55,
    ],
    UNIT_ADMIN: [
      2, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 48, 42, 50, 54, 54.1, 55,
    ],
    EDUCATOR: [8, 15, 24, 33.2, 41, 53, 51, 50, 54],
    DEPUTY_DIRECTORATE: [
      1, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 54, 54.1, 55,
    ],
    ...
    GIGA_ADMIN: [
      ...
      31, 33.1, 34, 35, 36, 38, 16, 40, 44, 46, 48, 50, 54, 54.1, 55,
    ],
    GOD: [
