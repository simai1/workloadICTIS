...
function App() {
  ...
  const metodRole = {
    ...
    DEPARTMENT_HEAD: [
      ...
      32, 33, 33.1, 34, 36, 16, 38, 39, 40, 49, 50, 51, 52, 54, 56,
    ],
    DIRECTORATE: [
      1, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 54, 55,
    ],
    UNIT_ADMIN: [
      2, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 48, 42, 50, 54, 55,
    ],
    ...
    GIGA_ADMIN: [
      ...
      31, 33.1, 34, 35, 36, 38, 16, 40, 44, 46, 48, 50, 54, 55,
    ],
    GOD: [
