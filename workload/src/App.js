...
function App() {
  ...
  const metodRole = {
    ...
    EDUCATOR: [8, 15, 24, 33.2, 41, 53, 51, 50, 54, 57, 58],
    DEPUTY_DIRECTORATE: [
      1, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 54, 54.1, 55, 57,
    ],
    DEPUTY_DEPARTMENT_HEAD: [
      ...
      32, 33, 33.1, 34, 36, 16, 38, 39, 40, 49, 50, 51, 52, 54, 54.1, 56, 57, 58
    ],
    GIGA_ADMIN: [
  ...
  const [popUpTextArea, SetPopUpTextArea] = useState(false); //!индикатор что данные обновлены через попап
