...
function App() {
  ...
  const metodRole = {
    ...
    LECTURER: [1.1, 15, 17, 17.1, 18, 20, 22, 24, 33.2, 34, 37, 41, 53, 51, 50, 56],
    DEPARTMENT_HEAD: [
    ...
    DIRECTORATE: [
      ...
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 57
    ],
    UNIT_ADMIN: [
      2, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 48, 42, 50, 57
    ],
    EDUCATOR: [15, 24, 33.2, 41, 53, 51, 50, 56],
    DEPUTY_DIRECTORATE: [
      1, 3, 4, 8, 9, 10, 11, 12, 13, 14, 17, 20, 21, 23, 25, 26, 27, 28, 30, 31,
      33.1, 34, 35, 36, 38, 16, 40, 44, 47, 49, 50, 57
    ],
    ...
    GIGA_ADMIN: [
      ...
      31, 33.1, 34, 35, 36, 38, 16, 40, 44, 46, 48, 50, 57
    ],
    GOD: [
